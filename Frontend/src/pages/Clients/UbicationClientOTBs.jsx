...
import { getCantones, getCantonUsers, getClients, getOTBs, getOTBUser } from '../../api/client';
...
export default function UbicationClientOTBS() {
    ...
    const changeSection = async (OTBName) => {
        try {
            const response = await getOTBUser(OTBName);
